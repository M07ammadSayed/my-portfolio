	...
	return (
		<>
			{meteorStyles.map((style, idx) => (
				<span
					key={"meteor" + idx}
					className="pointer-events-none absolute left-1/2 top-1/2 h-0.5 w-0.5 rotate-[215deg] animate-meteor-effect rounded-[9999px] bg-cyan-500 shadow-[0_0_0_1px_#ffffff10]"
					style={style}
				>
