...
export default function PremiumLoader({
	...
	return (
		<motion.div
			className="fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-[#080810] text-[#06b6d4] font-mono"
			initial={{ opacity: 1 }}
		...
		>
			...
			<div className="relative w-32 h-32 mb-12">
				{/* Outer Ring 1 */}
				<motion.span
					className="absolute inset-0 rounded-full border-2 border-[#06b6d4]/20 border-t-[#06b6d4]"
					animate={{ rotate: 360 }}
					transition={{
						duration: 2,
						repeat: Infinity,
				...
				<motion.span
					className="absolute inset-2 rounded-full border-2 border-[#ff6ec7]/20 border-b-[#ff6ec7]"
					animate={{ rotate: -360 }}
					transition={{
						duration: 3,
						repeat: Infinity,
				...
				{/* Inner Core Pulse */}
				<motion.div
					className="absolute inset-8 rounded-full bg-[#06b6d4]/10 blur-xl"
			...
			<div className="w-64 space-y-4">
				...
				<motion.p
					...
					className="text-center text-xs text-[#06b6d4]/80 h-4"
				>
					{status}
				</motion.p>
			</div>
