...
export default function PageManager({
	...
	useEffect(() => {
		...
		console.log(
			...
			"background: #030014; color: #d946ef; border: 1px solid #d946ef; padding: 5px 10px; border-radius: 5px; font-family: monospace; font-size: 12px; font-weight: bold;",
		);
		console.log(
	...
	return (
		<>
			...
			<motion.div
				className="min-h-[100dvh] bg-[#030014] text-slate-200 font-sans text-base leading-relaxed tracking-tight overflow-x-hidden relative"
				style={{
